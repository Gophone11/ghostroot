...
from ghostroot.dispatcher.protocol.client import ApiResult, GhostrootClient
...
class HeartbeatLease:
    ...
    def for_report(
        ...
        return cls(
            heartbeat=lambda: client.report_heartbeat(project_id, report_id, worker_name),
            scope=f"project={project_id} report={report_id}",
            worker_name=worker_name,
            interval=interval,
        )
