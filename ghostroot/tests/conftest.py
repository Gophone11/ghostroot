...
from ghostroot.dispatcher.config import DispatchConfig
from ghostroot.dispatcher.protocol.client import ApiResult
from ghostroot.dispatcher.workers.base import DriverResult
from ghostroot.server.models import Fact, Hint, Intent, ProjectDetail, ProjectMeta
...
class FakeClient:
    ...
    concluded_payloads: list[dict] = field(default_factory=list)
    ...
    created_intent_payloads: list[dict] = field(default_factory=list)
    ...
    def export_project_for_model_context(self, _project_id: str) -> str:
        return "project: {}\nfacts: []\n"
    ...
    def conclude(
        ...
        *,
        ...
        self.concluded_payloads.append(
            {
    ...
    def create_intent(
        ...
        *,
        ...
        self.created_intent_payloads.append(
            {
                "project_id": project_id,
                "from": from_ids,
                "description": description,
    ...
    def update_project_status(self, project_id: str, status: str) -> ApiResult:
        ...
        self.project.project.status = status  # type: ignore[assignment]
        return ApiResult(200, {})
