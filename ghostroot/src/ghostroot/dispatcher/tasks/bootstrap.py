...
from ghostroot.dispatcher.prompting import format_hints, load_prompt, render_prompt
...
def run_bootstrap_task(
    ...
    try:
        ...
        first = run_worker_process(
            ...
            telemetry_task_type="bootstrap",
            telemetry_intent_id=intent.id,
        )
...
def _try_conclude_fallback(
    ...
    try:
        ...
        kind, fact = validate_bootstrap_conclude_payload(payload)
    except Exception as exc:
        LOG.warning(
