...
from ghostroot.dispatcher.logging import configure_logging
...
@click.group()
def main():
    """Ghostroot - Fact-graph based collaborative exploration protocol."""
...
def serve(host: str, port: int, db_path: str, log_level: str, access_log: bool):
    """Start the Ghostroot API server."""
